...
def script_from_shell():
    ...
    # e1="SimpleEntity-attributes"     entry_point=en1
    en1=EntityNode(id=1,   simple_entity=seSimpleEntity, URIInstance="http://thekoa.org/KS/entity/EntityNode/1")
    en2=EntityNode(id=2,   simple_entity=seAttribute,      attribute="attribute_set", is_many=True, URIInstance="http://thekoa.org/KS/entity/EntityNode/2")
    en3=EntityNode(id=3,   simple_entity=seAttributeType,  attribute="type", URIInstance="http://thekoa.org/KS/entity/EntityNode/3")
    en1.save();en2.save();en3.save();
    en1.child_nodes.add(en2); en1.save()
    en2.child_nodes.add(en3); en2.save()
    e1=Entity(id=1,entry_point=en1,name="SimpleEntity-attributes",description="",URIInstance="http://thekoa.org/KS/entity/Entity/1")
    e1.save()

        
    # e2="Entity-EntityNode-Application"    entry_point=en22
    en4=EntityNode(id=4, simple_entity=seEntity, URIInstance="http://thekoa.org/KS/entity/EntityNode/4")
    en5=EntityNode(id=5, simple_entity=seEntityNode,     attribute="entry_point", URIInstance="http://thekoa.org/KS/entity/EntityNode/5")
    en6=EntityNode(id=6, simple_entity=seSimpleEntity,   attribute="simple_entity", external_reference=True,URIInstance="http://thekoa.org/KS/entity/EntityNode/6")
    en7=EntityNode(id=7, simple_entity=seEntityNode,     attribute="child_nodes", is_many=True,URIInstance="http://thekoa.org/KS/entity/EntityNode/7")
    en8=EntityNode(id=8, simple_entity=seAttribute,      attribute="attribute_set", is_many=True, URIInstance="http://thekoa.org/KS/entity/EntityNode/8")
    en9=EntityNode(id=9, simple_entity=seAttributeType,  attribute="type", external_reference=True, URIInstance="http://thekoa.org/KS/entity/EntityNode/9")
    en10=EntityNode(id=10, simple_entity=seAttributeInAMethod,  attribute="attributeinamethod_set", is_many=True, URIInstance="http://thekoa.org/KS/entity/EntityNode/10")
    en11=EntityNode(id=11, simple_entity=seMethod,  attribute="implementation_method", URIInstance="http://thekoa.org/KS/entity/EntityNode/11")
    en12=EntityNode(id=12, simple_entity=seWorkflowStatus,  attribute="initial_statuses", is_many=True, URIInstance="http://thekoa.org/KS/entity/EntityNode/12")
    en13=EntityNode(id=13, simple_entity=seWorkflow,  attribute="workflow", URIInstance="http://thekoa.org/KS/entity/EntityNode/13")
    en14=EntityNode(id=14, simple_entity=seWorkflowStatus,  attribute="final_status", URIInstance="http://thekoa.org/KS/entity/EntityNode/14")
    en15=EntityNode(id=15, simple_entity=seApplication,  attribute="application_set", is_many=True, URIInstance="http://thekoa.org/KS/entity/EntityNode/15")
    ...
    # e3="Workflow-statuses"     entry_point=en16
    en16=EntityNode(id=16, simple_entity=seWorkflow, URIInstance="http://thekoa.org/KS/entity/EntityNode/16")
    en17=EntityNode(id=17, simple_entity=seWorkflowStatus, attribute="workflowstatus_set", is_many=True,URIInstance="http://thekoa.org/KS/entity/EntityNode/17")
    en16.save();en17.save();
    en16.child_nodes.add(en17); en16.save()
    e3=Entity(id=3,entry_point=en16,name="Workflow-statuses",description="",URIInstance="http://thekoa.org/KS/entity/Entity/3")
    e3.save()
