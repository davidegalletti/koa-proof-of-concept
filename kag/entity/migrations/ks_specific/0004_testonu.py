...
def forwards_func(apps, schema_editor):
    ...
    KSs = KnowledgeServer.objects.using(db_alias).bulk_create([
        KnowledgeServer(pk=2, name="Test interni.it KS", scheme="http", netloc="testinterniitks.thekoa.org", URIInstance="http://testonuks.thekoa.org/entity/KnowledgeServer/2", description="Test interni.it KS", organization=test_interni_it_org, this_ks=True),
    ])
