...
def forwards_func(apps, schema_editor):
    ...
    se = SimpleEntity.objects.using(db_alias).bulk_create([
        ...
        SimpleEntity(id=4, name="Workflow", namespace="entity",URIInstance="http://thekoa.org/KS/entity/SimpleEntity/4",name_in_this_namespace="Workflow",module="entity",description="",table_name="",id_field="id",name_field="name",description_field="description"),
        SimpleEntity(id=5, name="WorkflowStatus", namespace="entity",URIInstance="http://thekoa.org/KS/entity/SimpleEntity/5",name_in_this_namespace="WorkflowStatus",module="entity",description="",table_name="",id_field="id",name_field="name",description_field="description"),
        SimpleEntity(id=6, name="Method", namespace="entity",URIInstance="http://thekoa.org/KS/entity/SimpleEntity/6",name_in_this_namespace="Method",module="application",description="",table_name="",id_field="id",name_field="name",description_field="description"),
        SimpleEntity(id=7, name="AttributeType", namespace="entity",URIInstance="http://thekoa.org/KS/entity/SimpleEntity/7",name_in_this_namespace="AttributeType",module="entity",description="",table_name="",id_field="id",name_field="name",description_field=""),
        SimpleEntity(id=8, name="Widget", namespace="entity",URIInstance="http://thekoa.org/KS/entity/SimpleEntity/8",name_in_this_namespace="Widget",module="application",description="",table_name="",id_field="id",name_field="widgetname",description_field=""),
        SimpleEntity(id=9,name="EntityNode", namespace="entity",URIInstance="http://thekoa.org/KS/entity/SimpleEntity/9",name_in_this_namespace="EntityNode",module="entity",description="",table_name="",id_field="id",name_field="attribute",description_field=""),
        SimpleEntity(id=10,name="Entity",     namespace="entity",URIInstance="http://thekoa.org/KS/entity/SimpleEntity/10",name_in_this_namespace="Entity",    module="entity",description="",table_name="",id_field="id",name_field="name",     description_field=""),
        SimpleEntity(id=11,name="AttributeInAMethod", namespace="application",URIInstance="http://thekoa.org/KS/entity/SimpleEntity/11",name_in_this_namespace="AttributeInAMethod",module="application",description="",table_name="",id_field="id",name_field="name",description_field=""),
        SimpleEntity(id=12, name="Organization", namespace="entity", URIInstance="http://thekoa.org/KS/entity/SimpleEntity/12", name_in_this_namespace="Organization", module="entity", description="", table_name="", id_field="id", name_field="name", description_field="description"),
        SimpleEntity(id=13, name="EntityInstance", namespace="entity", URIInstance="http://thekoa.org/KS/entity/SimpleEntity/13", name_in_this_namespace="EntityInstance", module="entity", description="", table_name="", id_field="id", name_field="", description_field=""),
...
#     EntityInstance
    ...
    EntityInstance.objects.using(db_alias).bulk_create([
        EntityInstance(id= 1,root_id= 1,owner_knowledge_server=the_koa_org_ks,entity=eSimpleEntityAttributes,workflow=wgeneric,current_status=ws[0],entry_point_instance_id= 1,version_major=0,version_minor=1,version_patch=0,version_description="",URIInstance="http://thekoa.org/KS/entity/EntityInstance/1",version_released=True),
        EntityInstance(id= 2,root_id= 2,owner_knowledge_server=the_koa_org_ks,entity=eSimpleEntityAttributes,workflow=wgeneric,current_status=ws[0],entry_point_instance_id= 2,version_major=0,version_minor=1,version_patch=0,version_description="",URIInstance="http://thekoa.org/KS/entity/EntityInstance/2",version_released=True),
        EntityInstance(id= 3,root_id= 3,owner_knowledge_server=the_koa_org_ks,entity=eSimpleEntityAttributes,workflow=wgeneric,current_status=ws[0],entry_point_instance_id= 3,version_major=0,version_minor=1,version_patch=0,version_description="",URIInstance="http://thekoa.org/KS/entity/EntityInstance/3",version_released=True),
        EntityInstance(id= 4,root_id= 4,owner_knowledge_server=the_koa_org_ks,entity=eSimpleEntityAttributes,workflow=wgeneric,current_status=ws[0],entry_point_instance_id= 4,version_major=0,version_minor=1,version_patch=0,version_description="",URIInstance="http://thekoa.org/KS/entity/EntityInstance/4",version_released=True),
        EntityInstance(id= 5,root_id= 5,owner_knowledge_server=the_koa_org_ks,entity=eSimpleEntityAttributes,workflow=wgeneric,current_status=ws[0],entry_point_instance_id= 5,version_major=0,version_minor=1,version_patch=0,version_description="",URIInstance="http://thekoa.org/KS/entity/EntityInstance/5",version_released=True),
        EntityInstance(id= 6,root_id= 6,owner_knowledge_server=the_koa_org_ks,entity=eSimpleEntityAttributes,workflow=wgeneric,current_status=ws[0],entry_point_instance_id= 6,version_major=0,version_minor=1,version_patch=0,version_description="",URIInstance="http://thekoa.org/KS/entity/EntityInstance/6",version_released=True),
        EntityInstance(id= 7,root_id= 7,owner_knowledge_server=the_koa_org_ks,entity=eSimpleEntityAttributes,workflow=wgeneric,current_status=ws[0],entry_point_instance_id= 7,version_major=0,version_minor=1,version_patch=0,version_description="",URIInstance="http://thekoa.org/KS/entity/EntityInstance/7",version_released=True),
        EntityInstance(id= 8,root_id= 8,owner_knowledge_server=the_koa_org_ks,entity=eSimpleEntityAttributes,workflow=wgeneric,current_status=ws[0],entry_point_instance_id= 8,version_major=0,version_minor=1,version_patch=0,version_description="",URIInstance="http://thekoa.org/KS/entity/EntityInstance/8",version_released=True),
        EntityInstance(id= 9,root_id= 9,owner_knowledge_server=the_koa_org_ks,entity=eSimpleEntityAttributes,workflow=wgeneric,current_status=ws[0],entry_point_instance_id= 9,version_major=0,version_minor=1,version_patch=0,version_description="",URIInstance="http://thekoa.org/KS/entity/EntityInstance/9",version_released=True),
        EntityInstance(id=10,root_id=10,owner_knowledge_server=the_koa_org_ks,entity=eSimpleEntityAttributes,workflow=wgeneric,current_status=ws[0],entry_point_instance_id=10,version_major=0,version_minor=1,version_patch=0,version_description="",URIInstance="http://thekoa.org/KS/entity/EntityInstance/10",version_released=True),
        EntityInstance(id=11,root_id=11,owner_knowledge_server=the_koa_org_ks,entity=eSimpleEntityAttributes,workflow=wgeneric,current_status=ws[0],entry_point_instance_id=11,version_major=0,version_minor=1,version_patch=0,version_description="",URIInstance="http://thekoa.org/KS/entity/EntityInstance/11",version_released=True),
        EntityInstance(id=12,root_id=12,owner_knowledge_server=the_koa_org_ks,entity=eSimpleEntityAttributes,workflow=wgeneric,current_status=ws[0],entry_point_instance_id=12,version_major=0,version_minor=1,version_patch=0,version_description="",URIInstance="http://thekoa.org/KS/entity/EntityInstance/12",version_released=True),
        EntityInstance(id=13,root_id=13,owner_knowledge_server=the_koa_org_ks,entity=eSimpleEntityAttributes,workflow=wgeneric,current_status=ws[0],entry_point_instance_id=13,version_major=0,version_minor=1,version_patch=0,version_description="",URIInstance="http://thekoa.org/KS/entity/EntityInstance/13",version_released=True),
        EntityInstance(id=14,root_id=14,owner_knowledge_server=the_koa_org_ks,entity=eEntityEntityNodeApplication,workflow=wgeneric,current_status=ws[0],entry_point_instance_id=1,version_major=0,version_minor=1,version_patch=0,version_description="",URIInstance="http://thekoa.org/KS/entity/EntityInstance/14",version_released=True),
        EntityInstance(id=15,root_id=15,owner_knowledge_server=the_koa_org_ks,entity=eEntityEntityNodeApplication,workflow=wgeneric,current_status=ws[0],entry_point_instance_id=2,version_major=0,version_minor=1,version_patch=0,version_description="",URIInstance="http://thekoa.org/KS/entity/EntityInstance/15",version_released=True),
        EntityInstance(id=16,root_id=16,owner_knowledge_server=the_koa_org_ks,entity=eEntityEntityNodeApplication,workflow=wgeneric,current_status=ws[0],entry_point_instance_id=3,version_major=0,version_minor=1,version_patch=0,version_description="",URIInstance="http://thekoa.org/KS/entity/EntityInstance/16",version_released=True),
    ])
