...
#     EntityInstance
    ...
    # "Entity-EntityNode-Application"    entry_point=en22
    ...
    # "Organization-KS"     entry_point=en18
        EntityNode(id=18, simple_entity=seOrganization,     URIInstance="http://rootks.thekoa.org/entity/EntityNode/18"),
        EntityNode(id=19, simple_entity=seKnowledgeServer,     attribute="knowledgeserver_set", is_many=True,URIInstance="http://rootks.thekoa.org/entity/EntityNode/19"),
    ])
    en1=en[0];en2=en[1];en3=en[2];en4=en[3];en5=en[4];en6=en[5];en7=en[6];en8=en[7];en9=en[8];en10=en[9];en11=en[10];en12=en[11];en13=en[12];en14=en[13];
    en15=en[14];en16=en[15];en17=en[16];en18=en[17];en19=en[18];
    ...
    eOrganizationKS=Entity(id=4,entry_point=en18,name="Organization-KS",description="",URIInstance="http://rootks.thekoa.org/entity/Entity/4")
    ...
    EntityInstance.objects.using(db_alias).bulk_create([
        ...
        EntityInstance(id=18,root_id=18,owner_knowledge_server=the_koa_org_ks,entity=eEntityEntityNodeApplication,workflow=wgeneric,current_status=ws[0],entry_point_instance_id=eOrganizationKS.id,                namespace="entity",version_major=0,version_minor=1,version_patch=0,version_description="",URIInstance="http://rootks.thekoa.org/entity/EntityInstance/18",version_released=True),
        EntityInstance(id=19,root_id=19,owner_knowledge_server=the_koa_org_ks,entity=eOrganizationKS,             workflow=wgeneric,current_status=ws[0],entry_point_instance_id=the_koa_org.id,                    namespace="entity",version_major=0,version_minor=1,version_patch=0,version_description="",URIInstance="http://rootks.thekoa.org/entity/EntityInstance/19",version_released=True),
    ])
