...
urlpatterns = patterns('',
    ...
    url(r'^browse_entity_instance/(?P<format>.*)/(?P<ks_url>[\w|=|%|.]+)/(?P<base64URIInstance>[\w|=|%|.]+)/$', views.browse_entity_instance, name='browse_entity_instance'),
                       ...
                       ###################   API   ####################
    #33:
    url(r'^api/simple_entity_definition/(?P<format>.*)/(?P<base64_SimpleEntity_URIInstance>[\w|=|%|.]+)/$', views.api_simple_entity_definition, name='api_simple_entity_definition'), 
    #36:
    url(r'^api/entity_instance/(?P<format>.*)/(?P<base64_EntityInstance_URIInstance>[\w|=|%|.]+)/$', views.api_entity_instance, name='api_entity_instance'),
    #64: 
